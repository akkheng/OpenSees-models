...
uniaxialMaterial FRPConfinedConcrete02 $FRPc -38 31500 -0.002 -JacketC 1.169 240000 0.019 1250 3 1500 1;
uniaxialMaterial FRPConfinedConcrete02 $FRPc2 -22 30700 -0.002 -JacketC 1.169 240000 0.019 1250 3 1500 1;
uniaxialMaterial Concrete01 $IDFRPreinf2 -38 -1.5 -30 -5.25;
...
#--------------------------------------------------------
section Fiber $lian -GJ [expr 1E17] {
patch circ $FRPc $nfFRPcoreC $nfFRPcoreR 0. 0. 0. $wa 0. 360.;
patch circ $FRPc2 $nfFRPcoreC $nfFRPcoreR2 0. 0. $wa $RCol 0. 360.;
...
section Fiber $FRPR21 -GJ [expr 1E17] {
patch circ $FRPc $nfFRPcoreC $nfFRPcoreR 0. 0. 0. $wa 0. 360.;
patch circ $FRPc2 $nfFRPcoreC $nfFRPcoreR2 0. 0. $wa $RCol 0. 360.;
...
section Fiber $FRPR25 -GJ [expr 1E17] {
patch circ $FRPc $nfFRPcoreC $nfFRPcoreR2 0. 0. 0 $RCol 0. 360.;
layer circ $IDsteel $numBarsCol $Abar 0. 0. $rsteel 0. [expr 360-360/$numBarsCol]
layer circ $IDsteel $numBarsCol2 $Abar 0. 0. $rsteel2 0. [expr 360-360/$numBarsCol2]
}
section Fiber $huayi -GJ [expr 1E17] {
patch circ $IDFRPreinf2 $nfFRPcoreC $nfFRPcoreR 0. 0. 0. $RCol 0. 360.;
...
section Fiber $ConR25 -GJ [expr 1E17] {
patch circ $IDConreinf $nfFRPcoreC $nfFRPcoreR 0. 0. 0. $RCol 0. 360.;
layer circ $IDsteel $numBarsCol $Abar 0. 0. $rsteel 0. [expr 360-360/$numBarsCol]
layer circ $IDsteel $numBarsCol2 $Abar 0. 0. $rsteel2 0. [expr 360-360/$numBarsCol2]
}
